...
#include "Demos/DemoPerlinWalk.h"
#include "Demos/DemoEcosystem.h"
#include "Demos/DemoAffiche.h"
...
std::vector<DemoConfig> availableDemos = {
    ...
    {"perlinWalk", "Perlin Walker", true, CreatePerlinWalkDemo},
    {"affiche", "affiche", true, CreateAfficheDemo},
    // {"ecosystem", "Ecosystem Simulation", true, CreateEcosystemDemo} 
